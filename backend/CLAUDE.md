...
| GET | `/entities/{id}/mockup` | UI_AREA `metadata.mockup` → 목업 HTML 렌더 (text/html, 비-UI_AREA 400, 범위밖 404) |
...
test_entity_mockup_api.py      GET /entities/{id}/mockup — UI_AREA 렌더, 비-UI_AREA 400, 범위밖 404, XSS 이스케이프
```
