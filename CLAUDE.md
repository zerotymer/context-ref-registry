...
테스트: 백엔드 **339 passed** (`cd backend && .venv/bin/pytest tests/`) · 프론트 **16 passed** (`cd frontend && pnpm test`)
...
| 216b0864-6b7f-4057-8b06-b2865dc9bc53 | `mcp-http-transport.md` | **in_progress** — MCP HTTP transport 전환. 단계 A(백엔드 `/mcp` 마운트·인증·범위 필터) 완료 (2026-06-06), 단계 C(BFF 프록시) 대기 |
