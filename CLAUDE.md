...
| 관리자 콘솔 | 로그인·사용자·프로젝트·멤버 관리 화면 | pending |
| 인증 고급 | 관리자·프로젝트 관리자 기능 | pending |
| 운영 준비 | 보안 & 모니터링 (2-1 API Key ✅, 2-2 Audit Log ✅) | in-progress |
| 확장 기능 | pgvector, Revision, Export | pending |

테스트: **195 passed** (`backend/.venv/bin/pytest tests/`)
...
| ce6d92bf-2c2d-4944-adb3-1089a6530e56 | instructions/security_ops.md | in-progress (2-1, 2-2 완료) |
